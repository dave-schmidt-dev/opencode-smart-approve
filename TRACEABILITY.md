...
| TASK-003 | REQ-004, REQ-005 | tests/integration/ambiguous-review.test.ts; tests/integration/approval-flow.test.ts; tests/security/reviewer-isolation.test.ts; tests/security/secret-boundary.test.ts; tests/eval/reviewer-contract-parity.test.ts; tests/e2e/opencode-contract-canary.test.ts |
